 ...
 */
function registerResources(server, logger) {
 ...
 */
function registerProjectResources(server, apiClient, authManager, logger) {
    // List projects resource
    server.resource("projects", new mcp_js_1.ResourceTemplate("tugboat://projects", { list: undefined }), async (uri) => {
        // Check authorization
    ...
    server.resource("project", new mcp_js_1.ResourceTemplate("tugboat://project/{id}", { list: undefined }), async (uri, { id }) => {
        // Check authorization
 ...
 */
function registerPreviewResources(server, apiClient, authManager, logger) {
    // List previews resource
    server.resource("previews", new mcp_js_1.ResourceTemplate("tugboat://previews", { list: undefined }), async (uri) => {
        try {
            // Check authorization
    ...
    server.resource("preview", new mcp_js_1.ResourceTemplate("tugboat://preview/{id}", { list: undefined }), async (uri, { id }) => {
        try {
            // Check authorization
    ...
    server.resource("previewLogs", new mcp_js_1.ResourceTemplate("tugboat://preview/{id}/logs", { list: undefined }), async (uri, { id }) => {
        try {
            // Check authorization
 ...
 */
function registerRepoResources(server, apiClient, authManager, logger) {
    // List repositories resource
    server.resource("repositories", new mcp_js_1.ResourceTemplate("tugboat://repositories", { list: undefined }), async (uri) => {
        try {
            // Check authorization
    ...
    server.resource("repository", new mcp_js_1.ResourceTemplate("tugboat://repository/{id}", { list: undefined }), async (uri, { id }) => {
        try {
            // Check authorization
